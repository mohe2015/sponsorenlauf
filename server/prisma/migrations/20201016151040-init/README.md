# Migration `20201016151040-init`

This migration has been generated by mohe2015 <Moritz.Hedtke@t-online.de> at 10/16/2020, 5:10:40 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."UserRole" AS ENUM ('ADMIN', 'TEACHER', 'VIEWER')
...
+  previewFeatures = ["atomicNumberOperations", "connectOrCreate", "transactionApi", "aggregateApi", "middlewares", "distinct"]
+}
+
+enum UserRole {
+  ADMIN
